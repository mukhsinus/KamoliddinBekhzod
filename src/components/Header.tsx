...
const Header = () => {
  ...
  const topText = scrolled ? 'text-foreground' : 'text-primary-foreground/80';
  const topMuted = scrolled ? 'text-muted-foreground' : 'text-primary-foreground/60';
      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4 lg:h-20">
        ...
        <Link to="/" className="flex items-center gap-3">
          ...
          <div className="hidden sm:block">
            <p className={`font-display text-sm font-semibold leading-tight ${topText}`}>
