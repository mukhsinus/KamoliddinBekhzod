    ...
    >
      ...
      <div className="mt-10 flex justify-center">
        <button
          ...
          className="px-8 py-3 bg-[#1f2f57] text-white rounded-lg hover:bg-[#2e4379] transition"
        >
    ...
    <div className="mt-12 pt-8 border-t space-y-6">
      ...
      <div className="flex flex-col items-center gap-4">
        <button
          ...
          disabled={loading}
          className="bg-[#1f2f57] text-white px-6 py-2 rounded-lg hover:bg-[#2e4379] transition"
        >
          {loading
            ? t("profile.saving")
